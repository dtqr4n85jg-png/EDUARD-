...
module.exports = {
    ...
    async execute(message, args, client) {
        ...
        const balance = client.userData.balances[userId];
    ...
    async handleButton(interaction, client) {
        ...
        if (interaction.customId.startsWith('casino_work')) {
            ...
            const workEmbed = new EmbedBuilder()
                ...
                .addFields({ name: '💰 Neues Guthaben', value: `${client.userData.balances[userId]} Chips` })
                .setTimestamp();
        ...
        if (interaction.customId.startsWith('casino_spin')) {
            ...
            client.userData.balances[userId] = newBalance;
            client.scheduleSave();
